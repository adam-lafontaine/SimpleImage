...
namespace simage
{
    ...
    template <typename T>
    static T get_pixel_value(SubMatrixView2D<T> const& src, Point2Df32 location)
    {
    ...
    static void rotate_n(ChannelSubMatrix2D<T, N> const& src, ChannelSubMatrix2D<T, N> const& dst, Point2Du32 origin, f32 rad)
	{
