...
namespace simd
{
    ...
    static inline vecf32 load_u8_broadcast(u8 value)
    {
        auto v_int = _mm512_set_epi32(value, value, value, value, value, value, value, value, value, value, value, value, value, value, value, value);
        return _mm512_cvtepi32_ps(v_int);
    }
    ...
    {
        auto p = src;
        auto v_int = _mm512_set_epi32(p[15], p[14], p[13], p[12], p[11], p[10], p[9], p[8], p[7], p[6], p[5], p[4], p[3], p[2], p[1], p[0]);
        return _mm512_cvtepi32_ps(v_int);
    }
...
namespace simd
{
    static void store_gray(vecf32 const& src, u8* dst)
    {
        ...
        auto v_int = _mm512_cvtps_epi32(src);

        _mm512_storeu_epi32(gray32, v_int);
